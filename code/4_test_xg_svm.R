...
write.csv(x = tmp.write, file = 'D:/workspace_R/thalas/20180427/result/xg/svm/result_chi_svm_val1_test5.csv',row.names = F)
...
tmp.write <- cbind(param,accu,i.tmp)
colnames(tmp.write) <- c('param','accu','fe')
write.csv(x = tmp.write, file = 'D:/workspace_R/thalas/20180427/result/xg/svm/result_chi_svm_val2_test5.csv',row.names = F)
# sum(te.y$te.case)/length(te.y$te.case)
...
tmp.write <- cbind(param,accu,i.tmp)
colnames(tmp.write) <- c('param','accu','fe')
write.csv(x = tmp.write, file = 'D:/workspace_R/thalas/20180427/result/xg/svm/result_chi_svm_val3_test5.csv',row.names = F)
# sum(te.y$te.case)/length(te.y$te.case)
...
tmp.write <- cbind(param,accu,i.tmp)
colnames(tmp.write) <- c('param','accu','fe')
write.csv(x = tmp.write, file = 'D:/workspace_R/thalas/20180427/result/xg/svm/result_chi_svm_val4_test5.csv',row.names = F)
# sum(te.y$te.case)/length(te.y$te.case)