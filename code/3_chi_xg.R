...
write.csv(x = tmp.write, file = 'D:/workspace_R/thalas/20180427/result/chi/xg/result_chi_xg_val3_test1.csv',row.names = F)
# sum(te.y$te.case)/length(val.y$val.case)
...
tmp.write <- cbind(accu,i.tmp)
colnames(tmp.write) <- c('accu','fe')
write.csv(x = tmp.write, file = 'D:/workspace_R/thalas/20180427/result/chi/xg/result_chi_xg_val2_test5.csv',row.names = F)
# sum(te.y$te.case)/length(val.y$val.case)
# tmp.write2 <- tmp.write[order(-tmp.write$accu),]
...
tmp.write <- cbind(accu,i.tmp)
colnames(tmp.write) <- c('accu','fe')
write.csv(x = tmp.write, file = 'D:/workspace_R/thalas/20180427/result/chi/xg/result_chi_xg_val3_test5.csv',row.names = F)
# sum(te.y$te.case)/length(val.y$val.case)
# tmp.write2 <- tmp.write[order(-tmp.write$accu),]
...
tmp.write <- cbind(accu,i.tmp)
colnames(tmp.write) <- c('accu','fe')
write.csv(x = tmp.write, file = 'D:/workspace_R/thalas/20180427/result/chi/xg/result_chi_xg_val4_test5.csv',row.names = F)
sum(te.y$te.case)/length(val.y$val.case)
tmp.write2 <- tmp.write[order(-tmp.write$accu),]
