...
for (k in 1:length(k.value)){
  ...
  write.csv(x = tmp.write, file = paste0('D:\\workspace_R\\thalas\\20180427\\result\\relieff\\xg\\result_relieff_xg_val1_test5_k',k.value[k],'.csv'),row.names = F)
...
for (k in 1:length(k.value)){
  ...
  tmp.write <- cbind(param,accu,i.tmp)
  colnames(tmp.write) <- c('param','accu','fe')
  write.csv(x = tmp.write, file = paste0('D:\\workspace_R\\thalas\\20180427\\result\\relieff\\xg\\result_relieff_xg_val2_test5_k',k.value[k],'.csv'),row.names = F)
...
for (k in 1:length(k.value)){
  ...
  tmp.write <- cbind(param,accu,i.tmp)
  colnames(tmp.write) <- c('param','accu','fe')
  write.csv(x = tmp.write, file = paste0('D:\\workspace_R\\thalas\\20180427\\result\\relieff\\xg\\result_relieff_xg_val3_test5_k',k.value[k],'.csv'),row.names = F)
...
for (k in 1:length(k.value)){
  ...
  tmp.write <- cbind(param,accu,i.tmp)
  colnames(tmp.write) <- c('param','accu','fe')
  write.csv(x = tmp.write, file = paste0('D:\\workspace_R\\thalas\\20180427\\result\\relieff\\xg\\result_relieff_xg_val4_test5_k',k.value[k],'.csv'),row.names = F)
